    ...
    <>
      ...
      <div className="container">
        <Routes>
          ...
          <Route path="/" element={<div className="mt-5 text-center"><h1 className="display-4 fw-bold">Bienvenue sur Octofit Tracker !</h1><p className="lead">Votre application fitness collaborative</p></div>} />
        </Routes>
      </div>
    </>
  );
